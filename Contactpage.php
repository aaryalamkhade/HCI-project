...
<br>
<img class="two" src="mitlogo.png" width="50" height="50"><p class="new"><b>CheckPoint</b></p>
<div class="py-5" >
  <br>
  <img class="three" src="Contact.jpg" width="50" height="50">
      <h4 >&nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp Contact Us</h4>
    </div> <br><br>
    <div class="w-50  m-auto ">
       <form action="mailto:arlamkhade21@gmail.com" method="post" >
          ...
          <input type="text" placeholder=" Write your Query " style="width: 250px;height: 90px;margin:auto;font-family: FontAwesome;" name="Query"  class="form-control" required> 
             ...
             <button type="Submit" style="background-color:green ; color:white ;margin:auto;display:block;box-shadow: 5px 5px 10px 1px #000 ;border-radius: 25px;width: 100px " >Send Mail</button>
        </form>
    </div>
