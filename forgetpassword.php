...
<br>
    <div class="w-50  m-auto ">
        <form action="userinfo.php" method="post">
            ...
            <label >Mobile</label>
             <input type="Mobile" style="width: 250px;margin:auto;" name="Username"  class="form-control"> 
             </div>
             <div class="form-group">
            <label>Verfication Code</label>
             <input type="Int" style="width: 250px;margin:auto;"  name="Passsword"  class="form-control"> 
             </div>
        </form>
    </div>
...
<div class="ri">
	<a href="newpassword.php" class="next round">&#8250;</a>
</div>
