...
<img class="three" src="thumps_up.jpg" width="50" height="50"> <br>
   ...
   <div class="ri">
   <button type="Submit" style="background-color:green ; color:white ;margin:auto;display:block;box-shadow: 5px 5px 10px 1px #000 ;border-radius: 15px;width: 90px " >Log In</button>
   </div>
       </form>
    </div>
